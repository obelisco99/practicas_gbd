...
CREATE TABLE alumnos(
  ...
  telefono CHAR(9),
  edad NUMBER(2),
  cif CHAR(9) CONSTRAINT alumnos_fk REFERENCES empresas(cif)
);
...
CREATE TABLE cursos (
  ...
  fecha_fin TIMESTAMP,
  cod_curso CONSTRAINT cursos_fk1 REFERENCES tipos_curso(cod_curso),
  dni_profesor CONSTRAINT cursos_fk2 REFERENCES profesores(dni)
);
